...
test.describe('Unified Analysis Report Component Validation', () => {
  test('should verify AnalysisReport component is used consistently', async ({ page }) => {
  ...
  test('should verify both pages use same styling classes', async ({ page }) => {
  ...
  test('should verify AnalysisReport component structure exists', async ({ page }) => {
    await page.goto('/');
