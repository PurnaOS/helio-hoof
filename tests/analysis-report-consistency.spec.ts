...
test.describe("Analysis Report Consistency", () => {
  ...
  test("should render identical analysis reports on main and history pages", async ({
    page,
  }) => {
  ...
  test("should display the same AnalysisReport component structure", async ({
    page,
  }) => {
  ...
  test("should use AnalysisReport component in both contexts", async ({
    page,
  }) => {
