...
test.describe("Name and Description Storage Validation", () => {
  ...
  test("should store and display name and description for new analysis", async ({
    ...
    const analysisDescription =
      "This is a test analysis to validate name and description storage";
  ...
  test("should handle empty name and description gracefully", async ({
    page,
  }) => {
    ...
    await expect(
      page.getByText(`Single Image Analysis - ${currentDate}`),
    ).toBeVisible();
  });

  test("should validate multi-image analysis name/description storage", async ({
    page,
  }) => {
    // Fill in name and description for multi-image analysis
    const analysisName = `Multi Image Test ${Date.now()}`;
    const analysisDescription =
      "Testing multi-image analysis with name and description";
